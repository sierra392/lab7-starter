...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		let shDom = this.attachShadow({mode: 'open'});
		console.log("shouldve attached to shadowDom");
		console.log(shDom)
		...
		* {
		...
		`;
		  ...
		  shDom.append(styElem);
		  shDom.append(artElem);
	...
	set data(data) {
		...
		let articleElem = shadowRoot.querySelector('article');
